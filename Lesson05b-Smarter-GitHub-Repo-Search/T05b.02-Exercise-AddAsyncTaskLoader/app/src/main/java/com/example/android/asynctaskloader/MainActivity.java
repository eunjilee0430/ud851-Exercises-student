...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GITHIB_SEARCH_LOADER = 22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(GITHIB_SEARCH_LOADER,  null, this);
    }
    ...
    private void makeGithubSearchQuery() {
        ...
        Loader<String> githubSearchLoader = loaderManager.getLoader(GITHIB_SEARCH_LOADER);
        if(githubSearchLoader == null){
            loaderManager.initLoader(GITHIB_SEARCH_LOADER, queryBundle, this);
        }else{
            loaderManager.restartLoader(GITHIB_SEARCH_LOADER, queryBundle, this);
        }
    ...
    @Override
    public Loader<String> onCreateLoader(int id, final Bundle args) { // final : we can access them from our inner class function.
