...
public class NotificationUtils {
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        PendingIntent pendingIntent = PendingIntent.getService(
                context, ACTION_IGNORE_PENDING_INTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification,"I DID", pendingIntent);
