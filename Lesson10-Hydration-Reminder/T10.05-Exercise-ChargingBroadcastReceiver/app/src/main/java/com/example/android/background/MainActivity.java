...
public class MainActivity extends AppCompatActivity implements
    ...
    IntentFilter mCharningIntentFilter;
    BroadcastReceiver mCharningReceiver;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // and an IntentFilter
        mCharningIntentFilter = new IntentFilter();
        mCharningIntentFilter.addAction(Intent.ACTION_POWER_CONNECTED);
        mCharningIntentFilter.addAction(Intent.ACTION_POWER_DISCONNECTED);
        ...
        mCharningReceiver = new ChargingBroadcastReceiver();
    }
    ...
    protected void onResume() {
        super.onResume();
        registerReceiver(mCharningReceiver, mCharningIntentFilter);
    }
    ...
    protected void onPause() {
        super.onPause();
        unregisterReceiver(mCharningReceiver);
    }
    ...
    private void showChargning(boolean isCharging){
        if(isCharging){
