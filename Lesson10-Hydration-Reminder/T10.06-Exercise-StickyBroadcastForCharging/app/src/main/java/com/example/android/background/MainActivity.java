...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            // charging method
            boolean isCharning = batteryManager.isCharging();
            ...
            int battery = intent.getIntExtra(BatteryManager.EXTRA_STATUS, -1);
            boolean isCharging = battery == BatteryManager.BATTERY_STATUS_CHARGING || battery == BatteryManager.BATTERY_STATUS_FULL;
